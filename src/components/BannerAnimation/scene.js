      ...
      <Suspense fallback={null}>
        <a.mesh
          ...
          onPointerUp={() => {
            ...
            setMode(!mode)
            setBg({ background: !mode ? navContext.setTheme(LightTheme) : navContext.setTheme(DarkTheme), fill: !mode ? navContext.setTheme(LightTheme) : navContext.setTheme(DarkTheme) })
          }}>
